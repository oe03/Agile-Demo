...
@pytest.mark.parametrize("company_name,should_be_valid", [
    ("", False),                      # empty
...
@pytest.mark.parametrize("title,should_be_valid", [
    ("", False),                          # empty
    ("   ", False),                       # whitespace only
    ("A", True),                          # single character
...
@pytest.mark.parametrize("description,should_be_valid", [
    ("", False),                          # empty
    ("   ", False),                       # whitespace only
    ("A", True),                          # single character
    ...
    ("<script>alert(1)</script>", True),  # HTML/script tags (currently allowed, worth flagging for XSS review)
...
@pytest.mark.parametrize("salary,should_be_valid", [
    ("", False),                      # empty
    ("   ", False),                   # whitespace only
...
@pytest.mark.parametrize("location,should_be_valid", [
    ("", False),                      # empty
    ("   ", False),                   # whitespace only
    ("A", True),                      # single character
...
@pytest.mark.parametrize("job_type,should_be_valid", [
    ("", False),                      # empty
    ("   ", False),                   # whitespace only
...
@pytest.mark.parametrize("skills,should_be_valid", [
    ("", False),                          # empty
    ("   ", False),                       # whitespace only
    ...
    ("Python, , JavaScript", True),       # extra comma (currently allowed, empty entries just get filtered)
