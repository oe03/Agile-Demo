...
# --- Converts a stored datetime into a human-readable "X ago" string ---
...
# --- Validate job posting fields (shared by create and update) ---
...
# --- Get all job postings (public, no auth needed) ---
@router.get("/jobs")
def get_jobs():
...
# --- Get a single job by ID (used to pre-fill the edit form) ---
...
# --- Update an existing job posting (employer, owner only) ---
